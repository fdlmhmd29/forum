      ...
      <article class="p-5 bg-white shadow">
        <div class="grid grid-cols-8">
          ...
          <div class="col-span-7 space-y-6">
            <div class="space-y-3">
              <h2 class="text-xl font-bold tracking-wid text-gray-600 hover:text-blue-400">{{ $thread->title() }}</h2>
              <span class="text-xs font-bold text-blue-500">{{ $thread->author()->name }}</span>
      ...
      <div class="p-5 space-y-4 text-gray-500 bg-white border-l border-blue-300 shadow">
        <div class="grid grid-cols-8">
          <button
            ...
            <img class="object-cover w-16 h-16 rounded" src="{{ asset('img/avatars/person4.jpg') }}"
              alt="Person One" />
          </button>
          <div class="col-span-7 space-y-4">
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil tenetur alias maiores, sequi magni nam
              incidunt a beatae veritatis animi suscipit omnis ipsam, accusantium vitae impedit vero molestiae nostrum
              illo perspiciatis rerum? Recusandae dicta cumque nulla officiis explicabo aliquid nobis? Consectetur dicta
              fugiat quas amet corporis facere possimus asperiores harum?
            </p>
            <div class="flex justify-between">
              {{-- Likes --}}
              <div class="flex space-x-5 text-gray-500">
